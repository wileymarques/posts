...
- Mudar aplicação para ser campo de nome e botão de adicionar
  - Componente creator tem o botão add
  - Botão add emite evento para o componente principal mandando o nome do herói
  - Componente principal tem a lista de heróis
  - Ao evento ser emitido, inclui herói na lista
