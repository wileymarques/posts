...
- [x] Mudar aplicação para ser campo de nome e botão de adicionar
...
- [x] Criar biblioteca com o componente de listagem
- [ ] Fazer biblioteca receber e exibir a lista
  - [ ] Botão de excluir dispara evento para o pai remover o elemento da lista
- [ ] Converter biblioteca em Angular Elements
